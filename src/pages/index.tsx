    ...
    <div className="grid grid-rows-[1fr_auto_2fr] gap-4 m-4">
      ...
      <div className="text-muted-foreground">
        ...
        <ul className="my-3 ml-6 list-disc [&>li]:mt-2">
          ...
          <li>
            All intermediate values (which are later used in Animation) are
            generated using <b>interpolation</b>
          </li>
          <li>
            Start and end values are passed using{" "}
            <Code codeText="initial & animate" /> props, respectively. You can
            also pass series of values/states as in keyframes to{" "}
            <Code codeText="animate" /> prop.
          </li>
          <li>
            Duration and animation flow is controlled using{" "}
            <Code codeText="transition" /> prop.
          </li>
          {/* todo */}
          <li>Layout</li>
        </ul>
