    ...
    <div className='flex flex-col justify-center gap-4 m-4'>
      <div>
        <motion.svg key={reRenderKey} viewBox='0 0 600 200'>
          <motion.circle cx='100' cy='100' r='80' stroke='#ff0088' style={shape} initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} />
          <motion.line x1='220' y1='170' x2='360' y2='30' stroke='#8df0cc' style={shape} initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} />
          <motion.rect
            width='140'
            height='140'
            x='410'
